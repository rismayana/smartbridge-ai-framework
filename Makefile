...
help:
	@echo ""
	@echo "  SHMS Anomaly Detection — Pipeline Tasks (MLflow + DagsHub)"
	@echo "  ============================================================"
	@echo ""
	@echo "  SETUP"
	@echo "    install        Install semua dependencies (requirements.txt)"
	@echo "    check-config   Verifikasi config.yaml terbaca dengan benar"
	@echo "    check-mlflow   Cek koneksi MLflow ke DagsHub"
	@echo ""
	@echo "  DATA (DVC)"
	@echo "    data-pull      Pull data processed dari DagsHub remote"
	@echo "    data-push      Push data processed ke DagsHub remote"
	@echo ""
	@echo "  PIPELINE"
	...
	@echo "    evaluate       Phase 5 — Evaluasi & ablation study"
	@echo "    pipeline       Phase 3B + 4 + 5 (pipeline lokal penuh)"
	@echo ""
	@echo "  MLFLOW"
	@echo "    mlflow-ui      Buka MLflow UI lokal (http://localhost:5000)"
	@echo ""
	@echo "  Untuk LSTM & GNN: jalankan notebook di Google Colab"
